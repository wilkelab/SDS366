...
**Unique:** 63040, Mon./Wed. 3:30pm-5:00pm, UTC 4.132<br>

**Instructor:** Claus	O.	Wilke<br>
**Email:** wilke@austin.utexas.edu<br>
**Office Hours:** Tues. 9am–10am (open Zoom), Thurs. 10am–11am (open Zoom), or by appointment<br>

**Teaching Assistant:** Bahar Kasgari<br>
**Email:** btak@austin.utexas.edu<br>
**Office Hours:** Wed. 12:00pm–1:00pm (open Zoom), Thurs. 3pm–4pm (open Zoom), or by appointment<br>
...
10.     Data wrangling 2            `summarize()`, `join()`, `pivot_longer()`
...
15.     Compound figures            **patchwork** package
...
25.     Dealing with overplotting   jittering, 2d histograms,
                                    contour plots
...
28.     Web technologies and        CSS
        web design

29.     Animations                  **gganimate** package
...
Programming needs to be learned by doing, and a significant portion of the in-class time will be dedicated to working through simple problems. All programming exercises will be available through a web-based system, so the only system requirement for student computers is a modern web browser. However, students are welcome to install the necessary software (R, an IDE such as RStudio or Positron, and the required R packages) on their own computers and do all work locally.
...
Attendance in class will also be tracked on Canvas.
...
The graded components of this class will be homeworks, projects, peer-grading, and attendance. Each week either a homework, a project, or a peer-grading is due. Homeworks will be relatively short visualization problems to be solved by the student, usually involving some small amount of programming to achieve a specified goal. They are graded by the TA. Projects are larger and more involved data analysis problems that involve both programming and writing. They are peer-graded by the students. Students will have at least one week to complete each homework and two weeks to complete each project. The submission deadlines for homeworks and projects will be Thursdays at 11:59pm.

There will be seven homeworks and three projects. Both homeworks and projects need to be submitted electronically on Canvas. Homeworks are worth 8 points each and projects are worth 100 points each.
...
Attendance is tracked via simple quizzes on Canvas. Students will receive 4 point for every lecture they attend, up to a maximum of 88 points for 22 classes attended. No attendance points will be awarded in the first week of class. There are 27 classes after week one, so students can miss 5 classes and still receive full attendance points. This policy is intended to allow students to miss the occasional class for various reasons (minor illness, an important live event, too much going on in other classes) without having to ask for an excuse or providing an explanation. 
...
In total, there are 492 points that can be obtained in this class. Each project contributes approximately 20% to the final grade, the totality of all homeworks and peer grading contributes another 20% to the final grade, and the last 20% comes from attendance. **There are no traditional exams in this class and there is no final.**
...
Finally, please note that even though generative AI use is allowed, creating assignments in their entirety with AI is considered academic misconduct. In other words, you are not allowed to upload the project instructions and ask the AI to produce the entire assignment for you. You are also not allowed to use generative AI for peer grading.
