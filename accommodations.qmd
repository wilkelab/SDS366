...
- **Use of technology to audio record during class.** You are welcome to record audio, *for your own personal use as a study aid.* Audio recordings should not be shared or otherwise made available to third parties.
...
- **Flexibility with attendance.** Regular attendance is a component of the overall grade in this class. However, every student in the class can miss 4 lectures without grade penalty. If you expect that you may miss more than 4 lectures please reach out to me on Canvas.

  Arriving late or stepping out for a few minutes is not an issue, but students are generally expected to attend for the majority of the class period.
