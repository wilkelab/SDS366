...
- **Flexibility with attendance.** Regular attendance is a component of the overall grade in this class. However, you are not required to attend every single lecture. You can make up for missed lectures by participating in the online discussions on Canvas instead. See the participation component of the class grade [described in the syllabus.](syllabus.html#assignments-and-grading)
