...
To get familiar with Quarto, please download [this Quarto template worksheet,](../assets/assignments/intro_to_Quarto.qmd) complete it, and render into a PDF. You will use this same workflow in all homeworks and projects throughout the semester.