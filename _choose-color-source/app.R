...
# shiny::shinyAppDir("_choose-color-source")
#
# To deploy:
# shinylive::export("_choose-color-source", "choose-color")
# file.copy(from="_choose-color-source/hclcolorpicker.css", to="choose-color") 
# file.copy(from="_choose-color-source/hclcolorpicker_darkmode.css", to="choose-color") 
